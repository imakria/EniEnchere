...
<section id="enchereConnecte">
    ...
    <div class="container-fluid">
            ...
            <div class="row divPrincipaleAvecFiltre">
                <div class=" col12 col-md-8  colonne1">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control inputTextRechere my-0 py-1" type="text"
                               placeholder="Tapez votre mot clé ..." aria-label="Search" name="keyword">
                    </div>
                    <!--

                            <span class="input-group-text" id="basic-text1"><i class="fas fa-search text-black"
                                    aria-hidden="true"></i></span>
                        </div>
                        <input class="form-control my-0 py-1" type="text" placeholder="Le nom de l'article contient"
                    ...
                    <div class="row categorieContainer">
                        ...
                        <div class="btn-group divDropDown">
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false" id="categories">
                                Choisissez la catégorie <span class="caret littleScare"></span>
                            </button>
                            <ul class="dropdown-menu divDropDown">
                                <c:forEach items="${listeCategories}" var="categorie">
                                    <option onclick="filterSelection(${categorie.noCategorie})">${categorie.libelle}
                                    </option>
                                </c:forEach>
                            </ul>
                        </div>
                    ...
                    <div class="row divRadioEtCheckbox">
                        <div class="col divAchats col-12 col-md-4">
                            <div class="radio">
                                <label> <input type="radio" name="filtering" value="0" class="rbFilter"
                                               id="filteringON" checked> <strong>Achats</strong>
                                </label>
                            </div>
                            <div class="divCheckboxAchat">
                                <div id="filterOnControls">
                                    <div class="checkbox">
                                        <label> <input type="checkbox" name="encheresOuvertes"
                                                       value="encheresOuvertes">
                                            enchères ouvertes
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label> <input type="checkbox" name="mesEncheres" value="mesEncheres"> mes
                                            enchères
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label> <input type="checkbox" name="mesEncheresRemportees"
                        ...
                        <div class="col divMesVentes col-12 col-md-4">
                            <div class="radio">
                                <label> <input name="filtering" type="radio" value="1" class="rbFilter"
                                               id="filteringOff"> <strong>Mes
                                    ventes</strong>
                                </label>
                            </div>
                                ...
                                <div id="filterOnControls">
                                    <div class="checkbox">
                                        <label> <input type="checkbox" name="mesVentesEnCours"
                                                       value="mesVentesEnCours" disabled> mes ventes en cours
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label> <input type="checkbox" name="ventesNonDebutees"
                                                       value="ventesNonDebutees" disabled> ventes non débutées
                                        </label>
                                    </div>
                                    <div class="checkbox">
                ...
                <div class="alignerCarteProduit ">
                    <c:forEach items="${listeArticlesVendus}" var="articleVendu">
                        <div class="card-product filterDiv ${articleVendu.noCategorie} show">
                            <img src="${pageContext.servletContext.contextPath}/demoUpload/${articleVendu.image}"
                                class="" />
                            <div class="">
                                <h2 class="">
                                    <a
                                ...
                                <p class="">
                                    ...
                                    <a
                                        href="${pageContext.request.contextPath}/user/monprofil1?id=${id}">${utilisateur.pseudo}</a>
                                </p>
                            </div>
                        </div>
                    </c:forEach>
        ...
        <section class="productCard">
            <c:forEach items="${listeArticlesVendus}" var="articleVendu">
                <div class="OneProductCard filterDiv ${articleVendu.noCategorie} show">
                    <img src="${pageContext.servletContext.contextPath}/demoUpload/${articleVendu.image}" class="imageProduit" alt="">
                    <img src="${pageContext.servletContext.contextPath}/img/nouveaute-good.png" alt="pictoNouveaute" class="pictoNouveaute">

                    <div class="divTextDescription">
                        <div>
                            <a
                                    href="${pageContext.request.contextPath}/encherir?idArticle=${articleVendu.noArticle}&prixVente=${articleVendu.prixVente}" class="titreProduit">
                                <p>${articleVendu.nomArticle}</p>
                            </a>
                            <p class="descriptionProduit">Description du produit : C'est le meilleur robot cuisine
                                cla
                                cla class</p>
                        </div>
                        <div class="sectionDetail">
                            <div class="détailsVentesInlign">
                                <p class="prixDeVente">Prix : ${articleVendu.prixVente} points</p>
                                <p class="nombreDeVente">Il y'a eu 56 enchères</p>
                            </div>
                            <div class="détailsVentesInlign">
                                <p class="timer">Fin de l'enchère : ${articleVendu.dateFinEncheres}</p>
